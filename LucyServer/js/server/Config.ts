    ...
    , readerAntennaSpecs: // copied from Antenne layout 3 - RFID Blueprint versie 3.jpg
        [ { readerIp: '10.0.0.30'
          , antennaSpecs:
            ...
            , {name: 'A5', coord: {x:10.703, y:0.545}} // short range, manually positioned
            ...
            , {name: 'A8', coord: {x:15.535, y:1.772}} // short range, manually positioned
            ]
          }
        , { readerIp: '10.0.0.31'
          , antennaSpecs:
            [ {name: 'B1', coord: {x:10.111, y:7.966}} // short range, manually positioned
            ...
            , {name: 'B8', coord: {x:12.244, y:7.966}} // short range, manually positioned
            ]
          }
        , { readerIp: '10.0.0.32'
          , antennaSpecs:
            ...
            , {name: 'C7', coord: {x:3.071, y:8.193}} // short range, manually positioned
            , {name: 'C8', coord: {x:1.505, y:4.550}} // short range, manually positioned
            ]
          }
        , { readerIp: '10.0.0.33'
          , antennaSpecs:
